...
import { Button, Column, Heading, Row, Text } from "@pageforge/once-ui/components";
...
import { usePageTheme, useTheme, useThemeUtils } from "../src/contexts/ThemeContext";

export default function ThemeDemoPage() {
  const { setTheme } = usePageTheme();
  const { currentTheme, currentSiteTheme, availableThemes } = useTheme();
  const { preferredColorScheme } = useThemeUtils();
    ...
    <Column fill padding="l" gap="xl" maxWidth="l" horizontal="center">
      ...
      <Column gap="m" align="center">
        ...
        <Text variant="body-default-l" onBackground="neutral-weak" align="center">
          Explore the comprehensive theme system with 11 predefined themes and custom overrides
        </Text>
      </Column>

      {/* Current Theme Info */}
      <Column gap="m" padding="l" border="neutral-alpha-weak" radius="m" fillWidth>
      ...
      <Column gap="m" fillWidth>
        ...
        <Row gap="s" wrap>
          {demoThemes.map((demo, index) => (
            <Button key={index} variant="secondary" size="s" onClick={() => setTheme(demo.theme)}>
              {demo.name}
            </Button>
          ))}
        </Row>
      ...
      <Column gap="m" padding="l" border="neutral-alpha-weak" radius="m" fillWidth>
        ...
        <Column gap="s">
          <Text variant="body-default-s">
            <strong>1. Predefined Themes:</strong> 11 complete theme configurations with fonts,
            colors, and effects
          </Text>
          <Text variant="body-default-s">
            <strong>2. Style Overrides:</strong> Customize mode, brand colors, and neutral colors
          </Text>
          <Text variant="body-default-s">
            <strong>3. Priority System:</strong> Page themes override user preferences which
            override system defaults
          </Text>
          <Text variant="body-default-s">
            <strong>4. Font Integration:</strong> Each theme includes optimized font combinations
          </Text>
          <Text variant="body-default-s">
            <strong>5. Effects System:</strong> Gradients, masks, dots, lines, and grid patterns
          </Text>
        </Column>
      </Column>
        ...
        <Column gap="l">
          ...
          <Column gap="s">
            ...
            <Text variant="body-default-m">
              This is sample body text that shows how the current theme affects typography and
              colors. The font family is {currentTheme.font.primary.style.fontFamily}.
            </Text>
            <Text variant="label-default-s" onBackground="neutral-weak">
          ...
          <Column gap="s" padding="m" border="neutral-alpha-weak" radius="m">
            ...
            <Text variant="body-default-s" onBackground="neutral-weak">
              This card demonstrates border radius and color scheme theming. Current border style:{" "}
              {currentTheme.style.border}.
            </Text>
          </Column>
        </Column>
      </Column>
      ...
      <Column gap="m" padding="l" border="neutral-alpha-weak" radius="m" fillWidth>
        ...
        <Column gap="s">
          <Text variant="body-default-s">
            <strong>1. User Themes:</strong> Set siteTheme in user preferences (e.g.,
            &apos;minimal&apos;, &apos;dark&apos;, &apos;elegant&apos;)
          </Text>
          <Text variant="body-default-s">
            <strong>2. Style Overrides:</strong> Add themeOverrides to fine-tune colors and mode
          </Text>
          <Text variant="body-default-s">
            <strong>3. Page Overrides:</strong> Use <code>usePageTheme()</code> hook to set
            page-specific themes
          </Text>
          <Text variant="body-default-s">
            <strong>4. Component Integration:</strong> Use <code>useThemeUtils()</code> for
            theme-aware styling
          </Text>
          <Text variant="body-default-s">
            <strong>5. JSON Configuration:</strong> Add PageThemeOverride to your page JSON files
          </Text>
        </Column>
      </Column>
    </Column>
