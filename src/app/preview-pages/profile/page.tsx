...
import { Card, Flex, Text, Button } from '@pageforge/once-ui/components'
    ...
    <GenericLayout theme='minimal'>
        ...
        <Flex horizontal='space-between' vertical='center'>
          <Flex direction='column' gap='xs'>
            ...
            <Text variant='body-default-xs' onBackground='neutral-medium'>
              Live preview with{' '}
              {Array.isArray(pageConfig.content)
      ...
      <Card padding='l' background='surface' style={{ marginTop: '4rem' }}>
        <Flex direction='column' gap='m' style={{ textAlign: 'center' }}>
          ...
          >
            💡 This template automatically pulls data from UserContext for
