...
const PreviewPages = () => {
  const [selectedTemplate, setSelectedTemplate] = useState<TemplateType>("designer");
  ...
  const templates = [
    ...
    },
    {
      ...
      description: "Full-stack developer portfolio with comprehensive sections and technical focus",
      icon: "💻",
      color: "#3b82f6",
      sections: [
    ...
    },
    {
      ...
      description: "Professional service-focused landing page with pricing and testimonials",
      icon: "💼",
      color: "#10b981",
      sections: [
    ...
    <Flex direction="column" gap="xl" paddingY="xl" paddingX="l">
      ...
      <Flex direction="column" gap="m" style={{ textAlign: "center" }}>
        ...
        <Text variant="body-default-m" onBackground="neutral-medium">
          Select a template below to see the actual rendered page with all sections
        </Text>
      </Flex>
          ...
          <Flex direction="column" gap="m">
            <Flex style={{ alignItems: "center" }} gap="m">
              ...
              <Flex direction="column" gap="xs">
                <Heading variant="heading-strong-l">{currentTemplate.name}</Heading>
                <Text variant="body-default-m" onBackground="neutral-medium">
              ...
              <Flex direction="column" gap="xs">
                {currentTemplate.sections.map((section, index) => (
                  <Flex key={index} style={{ alignItems: "center" }} gap="xs">
                    <Text variant="body-default-s" style={{ color: currentTemplate.color }}>
                      •
                    </Text>
      ...
      <Card padding="l" background="brand-weak">
        <Flex direction="column" gap="m">
          <Heading variant="heading-strong-m">🚀 How to Use Preview Pages</Heading>
          <Flex direction="column" gap="s">
            <Text variant="label-default-s" onBackground="brand-strong">
              1. Select a Template
            </Text>
            <Text variant="body-default-s">
              Choose from Designer, Developer, Freelancer, or Profile templates above
            </Text>
            ...
            <Text variant="body-default-s">
              Click "View Live Preview" to see the fully rendered page with all sections
            </Text>
            ...
            <Text variant="body-default-s">
              Scroll through the preview to see how each section looks and functions
            </Text>
            ...
            <Text variant="body-default-s">
              Use the comparison tool to see differences between templates side by side
            </Text>
          </Flex>
        </Flex>
      </Card>
      ...
      <Card padding="l" background="surface">
        <Flex direction="column" gap="m">
          ...
          <Flex gap="m" wrap>
            ...
            <Button variant="secondary" href="/preview/template-comparison" prefixIcon="compare">
              Template Comparison
            </Button>
            <Button variant="secondary" href="/preview/quick-generator" prefixIcon="zap">
              Quick Generator
            </Button>
            <Button variant="secondary" href="/preview/sections" prefixIcon="grid">
              Section Showcase
            </Button>
          </Flex>
        </Flex>
