...
const ProfileDemo = () => {
  const [activeTab, setActiveTab] = useState<"template" | "context" | "preview">("template");
  ...
  const contextualTemplates = useContextualTemplates(mockUserProfile, mockUserProjects);

  const generateTemplate = (type: "basic" | "contextual") => {
    try {
      const config = type === "basic" ? profileTemplate() : contextualTemplates.profile();
  ...
  return (
    <Flex direction="column" gap="xl" paddingY="xl" paddingX="l">
      ...
      <Flex direction="column" gap="m" style={{ textAlign: "center" }}>
        <Heading variant="display-strong-l">Profile Template & UserContext 👤</Heading>
        ...
        <Flex direction="column" gap="l">
          <Card padding="l" background="surface">
            <Flex direction="column" gap="m">
              <Heading variant="heading-strong-m">📄 Profile Template Function</Heading>
              <Text variant="body-default-m" onBackground="neutral-medium">
                The profileTemplate() function creates a UserContext-integrated profile page
              </Text>
...
// - useUserSocialLinks() for social media`}
              ...
              <Button variant="primary" size="m" onClick={() => generateTemplate("basic")}>
          ...
          <Card padding="l" background="surface">
            <Flex direction="column" gap="m">
              <Heading variant="heading-strong-m">🪝 Contextual Integration</Heading>
              <Text variant="body-default-m" onBackground="neutral-medium">
...
// Handles data mapping, validation, and optimization`}
              ...
              <Button variant="primary" size="m" onClick={() => generateTemplate("contextual")}>
      ...
      {activeTab === "context" && (
        <Flex direction="column" gap="l">
          ...
          <Card padding="l" background="brand-weak">
            <Flex direction="column" gap="m">
              <Heading variant="heading-strong-m">🔄 Data Transformation</Heading>
              <Text variant="body-default-m">
                How contextual templates transform user data into PageForge format
              </Text>
        ...
        <Flex direction="column" gap="l">
          {generatedConfig ? (
            <>
              <Card padding="l" background="surface">
                <Flex direction="column" gap="m">
                  <Heading variant="heading-strong-m">👁️ Generated Configuration</Heading>
                  <Grid columns="3" gap="m">
                    <Flex direction="column" gap="s">
                      <Text variant="label-default-s" onBackground="brand-strong">
                        Page Type
                      </Text>
                      <Text variant="body-default-s">{generatedConfig.pageType}</Text>
                    </Flex>
                    <Flex direction="column" gap="s">
                      <Text variant="label-default-s" onBackground="brand-strong">
                        Sections
                      </Text>
                      <Text variant="body-default-s">{generatedConfig.content?.length || 0}</Text>
                    </Flex>
                    <Flex direction="column" gap="s">
                      <Text variant="label-default-s" onBackground="brand-strong">
                        Theme
                      </Text>
                      <Text variant="body-default-s">{generatedConfig.theme || "default"}</Text>
                    </Flex>
                  </Grid>
                </Flex>
              </Card>
              ...
              <Card padding="l" background="surface">
                <Flex direction="column" gap="m">
                  <Heading variant="heading-strong-m">🔍 Full Configuration</Heading>
                  <pre
                    style={{
                      background: "var(--neutral-weak)",
                      padding: "12px",
            ...
            <Card padding="l" background="surface" style={{ textAlign: "center" }}>
              <Flex direction="column" gap="m" style={{ alignItems: "center" }}>
                <Text style={{ fontSize: "3rem" }}>📄</Text>
                <Heading variant="heading-strong-m">No Configuration Generated</Heading>
                <Text variant="body-default-m" onBackground="neutral-medium">
                  Use the Template tab to generate a profile configuration
                </Text>
                <Button variant="primary" size="m" onClick={() => setActiveTab("template")}>
                  Go to Template Tab
                </Button>
              </Flex>
            </Card>
      ...
      <Card padding="l" background="brand-weak">
        <Flex direction="column" gap="m">
          <Heading variant="heading-strong-m">✨ Profile Template Features</Heading>
          <Grid columns="2" gap="m">
            <Flex direction="column" gap="s">
              <Text variant="label-default-s" onBackground="brand-strong">
                Built-in Sections
              </Text>
              <Text variant="body-default-s">• Hero with profile information</Text>
