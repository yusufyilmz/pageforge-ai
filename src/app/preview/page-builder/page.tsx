...
import { Card, Column, Flex, Heading, Text } from "@pageforge/once-ui/components";
...
const servicesPageConfig = PageBuilder.create("services", "/services")
  ...
  .withKeywords(["services", "web development", "consulting", "react", "nodejs"])
  .withMaxWidth("xl")
  .addHero({
  ...
  .addFeatures([
    {
      ...
      description: "Complete web applications using React, Node.js, and modern databases",
      icon: "code",
    },
    {
      title: "Technical Consulting",
      description: "Architecture planning, code reviews, and technical strategy guidance",
      icon: "chat",
    },
    {
  ...
  .addSection("contact-form", {
    ...
    description: "Ready to discuss your project? Let's schedule a consultation.",
    fields: [
        ...
        <Flex maxWidth="l" style={{ color: "white", margin: "0 auto" }}>
          <Column gap="s">
            ...
            <Text variant="body-default-l" style={{ color: "#e9d5ff" }}>
              Custom pages for <strong>unique requirements</strong> not covered by templates
            </Text>
      ...
      >
        <Flex maxWidth="l" style={{ margin: "0 auto" }}>
          <Column gap="l" fillWidth>
            ...
            >
              <Column gap="m">
                <Heading variant="heading-strong-s" style={{ color: "#7c2d12" }}>
