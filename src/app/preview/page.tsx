...
const PreviewCenter = () => {
  const previews = [
    ...
    },
    {
      ...
      description:
        'Profile page demonstrating real user context data integration',
      icon: '👤',
      badge: 'CONTEXT',
      badgeColor: '#3b82f6',
      features: [
    ...
    },
    {
      ...
      description:
        'Side-by-side comparison of all 4 templates with live configs',
      icon: '⚖️',
      badge: 'INTERACTIVE',
      badgeColor: '#ef4444',
      features: [
    ...
    <Flex direction='column' gap='xl' paddingY='xl' paddingX='l'>
      ...
      <Card padding='l' background='brand-weak' radius='m'>
        <Flex direction='column' gap='m' style={{ textAlign: 'center' }}>
          ...
          <Text variant='body-default-m' onBackground='neutral-medium'>
            View fully rendered template pages with all sections - see exactly
            how your pages will look!
          </Text>
          <Text variant='body-default-s' onBackground='neutral-medium'>
            Each template now includes 10+ comprehensive sections: hero, stats,
            projects, skills, testimonials, pricing, contact forms, and more.
          </Text>
          <Button
            variant='primary'
            size='m'
