  ...
  return (
    <Flex direction="column" gap="xl" paddingY="xl" paddingX="l">
      <Flex direction="column" gap="m" style={{ textAlign: "center" }}>
        <Heading variant="display-strong-l">Simplified Template System 🎯</Heading>
      ...
      <Grid columns="3" gap="l">
        {templates.map((template) => (
          <Flex
            ...
            radius="m"
            border="neutral-weak"
            background={selectedTemplate === template.id ? "brand-weak" : "surface"}
      ...
      <Flex direction="column" gap="m" padding="l" radius="m" background="surface">
        <Heading variant="heading-strong-m">Clean Architecture Benefits</Heading>
        <Grid columns="2" gap="m">
          <Flex direction="column" gap="s">
            ...
            <Text variant="body-default-s">• ContextualTemplateBuilder class</Text>
          ...
          <Flex direction="column" gap="s">
            ...
            <Text variant="body-default-s">• PageBuilder (manual building)</Text>
      ...
      {generatedConfig && (
        <Flex direction="column" gap="m" padding="l" radius="m" background="surface">
          <Heading variant="heading-strong-m">Generated Config: {selectedTemplate}</Heading>
          <Text variant="body-default-s" onBackground="neutral-medium">
