import { type SiteThemeType, type ThemeConfig, getThemeConfig } from "@pageforge/types/site";
 ...
 */
export const getOnceUIConfig = (themeType: SiteThemeType = "minimal"): ThemeConfig => {
