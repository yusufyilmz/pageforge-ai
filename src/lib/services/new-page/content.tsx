...
export const createContentConfig = (props: Partial<ContentConfig> = {}): ContentConfig => {
  ...
  const defaultPerson: PersonConfig = {
    ...
    role: isUsingExampleData ? "[Example] Software Developer" : "Software Developer",
  ...
  const defaultHome: HomeConfig = {
    ...
    headline: isUsingExampleData ? <>Example developer and builder</> : <>Developer and builder</>,
    subline: (
      <>
        I&apos;m {person.name}, a {person.role.toLowerCase()}
        {isUsingExampleData ? " (this is example content)" : ""}.
        <br /> {isUsingExampleData ? "Please customize this content." : "Welcome to my portfolio."}
      </>
    ),
  };
    ...
    intro: {
      ...
      description: (
        <>
          {isUsingExampleData ? (
            <>
              This is example content for {person.name}. Please replace this with your actual
              introduction, background, and what makes you unique as a {person.role.toLowerCase()}.
            </>
          ) : (
            <>
              {person.name} is a passionate {person.role.toLowerCase()} focused on creating
              innovative solutions and delivering quality work.
            </>
          )}
        </>
      ),
