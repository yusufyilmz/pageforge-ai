...
import type { ContentBlock, PricingSectionContent } from "@pageforge/types/page/pageTypes";
...
export const PricingSection = ({ block, index }: PricingSectionProps) => {
  ...
  const renderPlan = (plan: PricingSectionContent["plans"][0], planIndex: number) => (
    <Column
      key={planIndex}
      gap="l"
      padding="xl"
