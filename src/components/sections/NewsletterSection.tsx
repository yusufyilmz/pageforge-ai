...
import { Button, Column, Flex, Heading, Input, Text } from "@pageforge/once-ui/components";
...
export const NewsletterSection = ({ block, index }: NewsletterSectionProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Newsletter Form */}
      <Flex as="form" onSubmit={handleSubmit} fillWidth maxWidth="s" gap="m" direction="column">
        <Input
          id="newsletter-email"
          type="email"
