    ...
    >
      ...
      <Flex fillWidth gap="l" vertical="start" wrap>
        ...
        <Column flex={1} gap="m">
          ...
          <Flex gap="m" wrap>
            {email && (
              <Button href={`mailto:${email}`} variant="secondary" size="s" prefixIcon="email">
                {email}
              </Button>
            )}
            {phone && (
              <Button href={`tel:${phone}`} variant="secondary" size="s" prefixIcon="phone">
                {phone}
              </Button>
            )}
          </Flex>
        ...
        <Column fillWidth gap="m">
          ...
          <Flex gap="s" wrap>
            {skills.map((skill, skillIndex) => (
              <Column key={skillIndex} background="neutral-alpha-weak" padding="xs" radius="s">
