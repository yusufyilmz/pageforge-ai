...
import type { ContentBlock, CustomContentBlock } from "@pageforge/types/page/pageTypes";
...
export const renderSectionComponent = (block: ContentBlock, index: number, data?: any) => {
