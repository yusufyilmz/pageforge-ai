...
try {
  ...
  console.log("   Elements:", basicRequirements.elements.map((e: any) => e.type).join(", "));
...
try {
  ...
  console.log("   Elements:", industryRequirements.elements.map((e: any) => e.type).join(", "));
  console.log("   Custom requirements:", industryRequirements.customRequirements);
} catch (error) {
