...
sectionRegistry.register("features", () => import("../sections/FeaturesSection"));
sectionRegistry.register("experience", () => import("../sections/WorkExperienceSection"));
sectionRegistry.register("studies", () => import("../sections/StudiesSection"));
sectionRegistry.register("skills", () => import("../sections/TechnicalSkillsSection"));
sectionRegistry.register("socials", () => import("../sections/SocialLinksSection"));
sectionRegistry.register("gallery", () => import("../sections/GalleryGridSection"));
sectionRegistry.register("newsletter", () => import("../sections/NewsletterSection"));
sectionRegistry.register("table-of-contents", () => import("../sections/TableOfContentsSection"));
sectionRegistry.register("calendar-link", () => import("../sections/CalendarLinkSection"));
sectionRegistry.register("projects", () => import("../sections/ProjectsSection"));
sectionRegistry.register("posts-grid", () => import("../sections/PostsGridSection"));
sectionRegistry.register("about-hero", () => import("../sections/AboutHeroSection"));
sectionRegistry.register("heading", () => import("../sections/HeadingSection"));
sectionRegistry.register("text", () => import("../sections/TextSection"));
sectionRegistry.register("contact-form", () => import("../sections/ContactFormSection"));
sectionRegistry.register("testimonials", () => import("../sections/TestimonialsSection"));
...
sectionRegistry.register("timeline", () => import("../sections/TimelineSection"));
sectionRegistry.register("contact-info", () => import("../sections/ContactInfoSection"));
sectionRegistry.register("about", () => import("../sections/AboutSection"));
sectionRegistry.register("map", () => import("../sections/MapSection"));
sectionRegistry.register("blog-page", () => import("../sections/BlogPageSection"));
sectionRegistry.register("shop-items", () => import("../sections/ShopItemsSection"));
...
sectionRegistry.register("property", () => import("../sections/PropertySection"));
sectionRegistry.register("legal-text", () => import("../sections/LegalTextSection"));
